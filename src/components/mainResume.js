...
const mainResumePage = () => {
  ...
  <div class="container sm:px-5 md:px-10 lg:px-14">
      <div class="py-12 px-4 md:px-0">
          <!-- resume page title -->
          <h2 class="after-effect after:left-44">Tóm tắt</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-6 gap-y-6 mt-[30px]">
              ...
              <div>
                  <div class="flex items-center space-x-2 mb-4">
                      ...
                      <h4 class="text-5xl dark:text-white font-medium"> Giáo dục </h4>
                  </div>
                  <div
                      class="bg-[#fff4f4] dark:bg-transparent py-4 pl-5 pr-3 space-y-2 mb-6 rounded-lg dark:border-[#212425] dark:border-2">
                      <span class="text-tiny text-gray-lite dark:text-[#b7b7b7]">2020-2023</span>
                      <h3 class="text-xl dark:text-white"> FPT polytechnic </h3>
                      <p class="dark:text-[#b7b7b7]"> Hà Nội </p>
                  </div>
                  <div
              ...
              <div>
                  <div class="flex items-center space-x-2 mb-4">
                      ...
                      <h4 class="text-5xl dark:text-white font-medium"> Kinh Nghiệm </h4>
                  </div>
                  <div
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="col-span-1">
              ...
              <div class="mb-5">
                  <div class="flex justify-between mb-1">
                      <span
                          class=" font-semibold text-[#526377] dark:text-[#A6A6A6]">Photoshope</span>
