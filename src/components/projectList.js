...
const projectListPage = () => {
  return /*html*/ `
  <div id="1" class="bg-white   lg:rounded-2xl dark:bg-[#111111]">
  <div
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 my-6 pr-3">
          <div class="space-y-2">
              <p class="dark:text-white flex items-center text-[15px] sm:text-lg">
                  ...
                  Project :&nbsp;
                  <span class="font-medium"> Dự Án 1</span>
              </p>
              <p class="dark:text-white flex items-center text-[15px] sm:text-lg">
                  <i class="fa-solid fa-code text-lg mr-2 hidden sm:block"></i>
                  Langages :&nbsp;
                  <span class="font-medium">HTML, CSS, Js</span>
              </p>
          </div>
          ...
          <div class="space-y-2">
              <p
                  ...
                  Client :&nbsp; <span class="font-medium">Nguyễn Anh Tú</span>
              </p>
              <p class="dark:text-white flex items-center text-[15px] sm:text-lg">
                  <i
                  ...
                  <span
                      ...
                      <a href="https://github.com/" target="_blank"
                          rel="noopener noreferrer">www.github.com</a>
                  </span>
              </p>
          </div>
      </div>
